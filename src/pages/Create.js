...
export default function BlogPage() {
  ...
  const createShortenedLink = async (originalLink, accessPermission, credentials) => {
    const response = await fetch('https://wild-gray-pike-yoke.cyclic.app/create', {
      method: 'POST',
      body: JSON.stringify({
        originalLink,
        accessPermission,
  ...
  const handleSearch = () => {
    fetch(`https://wild-gray-pike-yoke.cyclic.app/search?search=${searchTerm}`)
  ...
  useEffect(() => {
    ...
    fetch('https://wild-gray-pike-yoke.cyclic.app/authen', {
      method: 'POST', // or 'PUT'
      headers: {
        'Content-Type': 'application/json',
              ...
              <div >{/* className="group-259" */}
                <div className="boxes">
                  ...
                  <a
                    ...
                    onMouseEnter={(e) => { e.target.style.backgroundColor = '#6666FF'; e.target.style.color = 'white'; }}
                    onMouseLeave={(e) => { e.target.style.backgroundColor = 'white'; e.target.style.color = '#6666FF'; }}
                  >
                    Database
                  </a>
                  {/* popup new contract 
                  ...
                  <div className="Box_select">
                    ...
                    <Autocomplete
                      ...
                      onChange={(event, value) => {
                        ...
                        handleDataClick(selectedData.employee_ID);
                      }}
                      renderInput={(params) => (
                        <TextField
                          {...params}
